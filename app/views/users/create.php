...
<body class="bg-purple-300 flex items-center justify-center min-h-screen ">
  ...
  <div class="p-8 rounded-2xl shadow-lg w-full max-w-md custom-container">
    ...
    <form action=" <?=site_url('users/create');?> " method="POST" class="space-y-4">
      ...
      <!-- Username -->
      <div>
        <label for="username" class="block text-sm font-medium text-pink-100">Username</label>
      ...
      <!-- Password -->
      <div>    
        <label for="password" class="block text-sm font-medium text-pink-100">Password</label>
      ...
      <!-- Role Selection -->
      <div>   
        <label for="role" class="block text-sm font-medium text-pink-100">Role</label>
        <select id="role" name="role" required 
          class="transparent-dropdown mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
